...
class _ProgramStreamProviderElement
    extends AutoDisposeStreamProviderElement<Program> with ProgramStreamRef {
...
class _ProgramFutureProviderElement
    extends AutoDisposeFutureProviderElement<Program?> with ProgramFutureRef {
...
class ProgramsByOrganizerStreamFamily
  ...
  /// See also [programsByOrganizerStream].
  ProgramsByOrganizerStreamProvider call(
    String organizerId,
  ) {
    return ProgramsByOrganizerStreamProvider(
      organizerId,
    );
  }
...
class ProgramsByOrganizerStreamProvider
  ...
  /// See also [programsByOrganizerStream].
  ProgramsByOrganizerStreamProvider(
    String organizerId,
  ) : this._internal(
