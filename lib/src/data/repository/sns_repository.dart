...
class SnsRepository extends BaseRepository {
  ...
  Future<void> followUser(String followingId) async {
    ...
    try {
      await callFunction<void>('v2_sns_follow_createFollow', {
  ...
  Future<void> unfollowUser(String followingId) async {
    ...
    try {
      await callFunction<void>('v2_sns_follow_deleteFollow', {
        'followingId': followingId,
  ...
  Future<Post> createPost({
    ...
    try {
      final response =
          await callFunction<Map<String, dynamic>>('v2_sns_post_createPost', {
            'content': content,
  ...
  Future<List<Post>> getFeed({int? limit, String? lastPostId}) async {
    ...
    try {
      final response =
          await callFunction<Map<String, dynamic>>('v2_sns_post_getFeed', {
      ...
      logger.e('getFeedError', time: DateTime.now(), error: e, stackTrace: st);
      rethrow;
    }
  }
  ...
  Future<void> likePost(String postId) async {
    ...
    try {
      await callFunction<void>('v2_sns_post_likePost', {
        'postId': postId,
      }, context: 'likePost');
  ...
  Future<void> unlikePost(String postId) async {
    ...
    try {
      await callFunction<void>('v2_sns_post_unlikePost', {
        'postId': postId,
      }, context: 'unlikePost');
  ...
  Future<void> markNotificationAsRead(String notificationId) async {
    ...
    try {
      await callFunction<void>('v2_sns_notification_markAsRead', {
        'notificationId': notificationId,
      }, context: 'markNotificationAsRead');
      logger.d(
        'markNotificationAsRead success - notificationId: $notificationId',
      );
    } on Exception catch (e, st) {
      logger.e(
  ...
  Future<void> deleteComment(String commentId) async {
    ...
    try {
      await callFunction<void>('v2_sns_comment_deleteComment', {
        'commentId': commentId,
