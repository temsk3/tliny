...
/// @nodoc
mixin _$Result<T> implements DiagnosticableTreeMixin {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( T data)?  success,TResult Function( Exception error,  StackTrace stackTrace)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Success() when success != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( T data)  success,required TResult Function( Exception error,  StackTrace stackTrace)  failure,}) {final _that = this;
switch (_that) {
case Success():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( T data)?  success,TResult? Function( Exception error,  StackTrace stackTrace)?  failure,}) {final _that = this;
switch (_that) {
case Success() when success != null:
return success(_that.data);case Failure() when failure != null:
return failure(_that.error,_that.stackTrace);case _:
...
class Success<T> extends Result<T> with DiagnosticableTreeMixin {
...
class Failure<T> extends Result<T> with DiagnosticableTreeMixin {
  const Failure({required this.error, required this.stackTrace}): super._();
