...
/// Create a copy of PriceData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? unitAmount = null,Object? currency = null,Object? productData = null,}) {
  return _then(_self.copyWith(
unitAmount: null == unitAmount ? _self.unitAmount : unitAmount // ignore: cast_nullable_to_non_nullable
...
class _PriceData implements PriceData {
   _PriceData({required this.unitAmount, required this.currency, required this.productData});
...
/// Create a copy of PriceData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? unitAmount = null,Object? currency = null,Object? productData = null,}) {
...
/// Create a copy of ProductData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? description = null,Object? images = null,Object? metaData = null,}) {
  return _then(_self.copyWith(
...
class _ProductData implements ProductData {
   _ProductData({required this.name, required this.description, required final  List<String> images, required this.metaData}): _images = images;
...
/// Create a copy of ProductData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? description = null,Object? images = null,Object? metaData = null,}) {
...
@JsonKey(name: 'product_id') String get productId;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'product_id')  String productId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MetaData() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'product_id')  String productId)  $default,) {final _that = this;
switch (_that) {
case _MetaData():
return $default(_that.productId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'product_id')  String productId)?  $default,) {final _that = this;
switch (_that) {
case _MetaData() when $default != null:
return $default(_that.productId);case _:
  return null;
...
class _MetaData implements MetaData {
   _MetaData({@JsonKey(name: 'product_id') required this.productId});
