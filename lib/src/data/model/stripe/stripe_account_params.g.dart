...
Map<String, dynamic> _$AccountParamsToJson(AccountParams instance) =>
    <String, dynamic>{
...
RequestedParams _$RequestedParamsFromJson(Map<String, dynamic> json) =>
    RequestedParams(required: json['required'] as bool?);
...
Map<String, dynamic> _$DobParamsToJson(DobParams instance) => <String, dynamic>{
  'day': instance.day,
