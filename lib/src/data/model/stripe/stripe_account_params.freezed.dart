...
/// Create a copy of CapabilitiesParams
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? bankTransferPayments = null,Object? cardPayments = null,Object? jcbPayments = null,Object? konbiniPayments = null,Object? transfers = null,}) {
  return _then(_self.copyWith(
bankTransferPayments: null == bankTransferPayments ? _self.bankTransferPayments : bankTransferPayments // ignore: cast_nullable_to_non_nullable
as RequestedParams,cardPayments: null == cardPayments ? _self.cardPayments : cardPayments // ignore: cast_nullable_to_non_nullable
as RequestedParams,jcbPayments: null == jcbPayments ? _self.jcbPayments : jcbPayments // ignore: cast_nullable_to_non_nullable
as RequestedParams,konbiniPayments: null == konbiniPayments ? _self.konbiniPayments : konbiniPayments // ignore: cast_nullable_to_non_nullable
as RequestedParams,transfers: null == transfers ? _self.transfers : transfers // ignore: cast_nullable_to_non_nullable
as RequestedParams,
  ));
}
/// Create a copy of CapabilitiesParams
...
class _CapabilitiesParams implements CapabilitiesParams {
  const _CapabilitiesParams({@JsonKey(name: 'bank_transfer_payments') required this.bankTransferPayments, @JsonKey(name: 'card_payments') required this.cardPayments, @JsonKey(name: 'jcb_payments') required this.jcbPayments, @JsonKey(name: 'konbini_payments') required this.konbiniPayments, required this.transfers});
...
/// Create a copy of CapabilitiesParams
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? bankTransferPayments = null,Object? cardPayments = null,Object? jcbPayments = null,Object? konbiniPayments = null,Object? transfers = null,}) {
...
class _RequestedParams implements RequestedParams {
  const _RequestedParams({required this.required});
...
class _BusinessProfileParams implements BusinessProfileParams {
  const _BusinessProfileParams({required this.mcc, required this.url, @JsonKey(name: 'product_description') required this.productDescription});
...
class _TosAcceptanceParams implements TosAcceptanceParams {
  const _TosAcceptanceParams({required this.ip, required this.data});
...
class _IndividualParams implements IndividualParams {
  const _IndividualParams({@JsonKey(name: 'first_name_kana') required this.firstNameKana, @JsonKey(name: 'first_name_kanji') required this.firstNameKanji, @JsonKey(name: 'last_name_kana') required this.lastNameKana, @JsonKey(name: 'last_name_kanji') required this.lastNameKanji, required this.dob, @JsonKey(name: 'address_kana') required this.addressKana, @JsonKey(name: 'address_kanji') required this.addressKanji, required this.email, required this.phone});
...
class _CompanyParams implements CompanyParams {
  const _CompanyParams({required this.name, @JsonKey(name: 'name_kana') required this.nameKana, @JsonKey(name: 'name_kanji') required this.nameKanji, @JsonKey(name: 'address_kana') required this.addressKana, @JsonKey(name: 'address_kanji') required this.addressKanji, required this.phone, required this.taxId});
...
class _DobParams implements DobParams {
  const _DobParams({required this.day, required this.month, required this.year});
...
class _AddressKanaParams implements AddressKanaParams {
  const _AddressKanaParams({required this.line1, @JsonKey(name: 'postal_code') required this.postalCode, required this.city, required this.state, required this.town});
...
class _AddressKanjiParams implements AddressKanjiParams {
  const _AddressKanjiParams({required this.line1, @JsonKey(name: 'postal_code') required this.postalCode, required this.city, required this.state, required this.town});
