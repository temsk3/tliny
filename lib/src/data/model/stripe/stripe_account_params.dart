...
class RequestedParams with _$RequestedParams {
  const factory RequestedParams({bool? required}) = _RequestedParams;
...
class CompanyParams with _$CompanyParams {
  const factory CompanyParams({
    String? name, // 法人の場合必須 //ローマ字または英語表記
    @JsonKey(name: 'name_kana') String? nameKana, // 法人の場合必須
    @JsonKey(name: 'name_kanji') String? nameKanji, // 法人の場合必須
    @JsonKey(name: 'address_kana') AddressKanaParams? addressKana,
    @JsonKey(name: 'address_kanji') AddressKanjiParams? addressKanji,
    String? phone,
    String? taxId, // 法人の場合必須
  }) = _CompanyParams;
