...
class TotalAmountNotifierFamily extends Family<AsyncValue<int>> {
  ...
  TotalAmountNotifierProvider call(List<Cart> list) {
    return TotalAmountNotifierProvider(list);
  }
...
class TotalAmountNotifierProvider
  ...
  ///
  /// Copied from [TotalAmountNotifier].
  TotalAmountNotifierProvider(List<Cart> list)
    : this._internal(
  ...
  @override
  FutureOr<int> runNotifierBuild(covariant TotalAmountNotifier notifier) {
    return notifier.build(list);
  }
