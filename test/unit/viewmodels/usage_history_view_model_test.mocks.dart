...
class MockUsageHistoryRepository extends _i1.Mock
  ...
  @override
  _i4.Stream<_i5.UsageHistory> watchUsageHistory(
    String? uid,
    String? id,
  ) =>
      (super.noSuchMethod(
  ...
  _i4.Future<List<_i5.UsageHistory>> readUsageHistory(String? uid) =>
      (super.noSuchMethod(
        ...
        returnValue:
            _i4.Future<List<_i5.UsageHistory>>.value(<_i5.UsageHistory>[]),
  ...
  @override
  _i4.Future<void> deleteUsageHistory(
    String? uid,
    String? id,
  ) =>
      (super.noSuchMethod(
...
class MockAuthRepository extends _i1.Mock implements _i7.AuthRepository {
  ...
  @override
  _i4.Stream<String?> get userId => (super.noSuchMethod(
  ...
  @override
  _i4.Future<void> signOutGoogle() => (super.noSuchMethod(
        Invocation.method(
          #signOutGoogle,
          [],
        ),
  ...
  @override
  _i4.Future<void> signInWithEmail(
    String? email,
    String? password,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i4.Future<void> updateEmail(String? email) => (super.noSuchMethod(
        Invocation.method(
          #updateEmail,
          [email],
        ),
