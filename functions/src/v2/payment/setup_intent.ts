...
const setupIntentOnCreate = onCall(
  async (request) => {
...
const setupIntentOnRetrieve = onCall(
  async (request) => {
    checkAuth(request)
...
const setupIntentOnUpdate = onCall(
  async (request) => {
    checkAuth(request)
    const setupIntentId: string = (request.data as any).setupIntentId
    const description = (request.data as any).description
...
const setupIntentOnConfirm = onCall(
  async (request) => {
    checkAuth(request)
    const setupIntentId: string = (request.data as any).setupIntentId
    const paymentMethodData = (request.data as any).payment_method_data
...
const setupIntentOnCancel = onCall(
  async (request) => {
    checkAuth(request)
    const setupIntentId: string = (request.data as any).setupIntentId
...
const setupIntentOnList = onCall(
  async (request) => {
    checkAuth(request)
    const customer = (request.data as any).customer
