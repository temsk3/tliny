...
// フォロー作成
export const v2_sns_follow_createFollow = onCall<{ followingId: string }>(
  async (request) => {
...
// フォロー削除
export const v2_sns_follow_deleteFollow = onCall<{ followingId: string }>(
  async (request) => {
...
// フォロワー一覧取得
export const v2_sns_follow_getFollowers = onCall<{
  userId: string
  limit?: number
}>(async (request) => {
...
// フォロー中一覧取得
export const v2_sns_follow_getFollowing = onCall<{
  userId: string
  limit?: number
}>(async (request) => {
